...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCKyWaRCXUgn8oVp1HpvnGE1ajAW0v9yCY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $streetViewAddressPosition	= 'TOP_RIGHT';						// The position of the Address control, eg. 'BOTTOM'
	var $streetViewControlPosition	= 'TOP_RIGHT';						// The position of the Street View control when viewing normal aerial map, eg. 'BOTTOM_RIGHT'
	...
	var $stylesAsMapTypes			= TRUE;					// If applying styles, whether to apply them to the default map or add them as additional map types
	...
	var $zoomControlPosition		= 'TOP_RIGHT';						// The position of the Zoom control, eg. 'BOTTOM_RIGHT'
