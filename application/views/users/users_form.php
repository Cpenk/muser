...
<!-- Batas Header -->
	    ...
	    <div class="form-group">
                ...
                <input type="text" class="form-control" name="level_user" id="level_user" placeholder="level_user" value="<?php echo $level_user; ?>" />
            </div>
	    <div class="form-group">
                <label for="enum">status <?php echo form_error('status') ?></label>
                <select type="text"  class="form-control select2" name="status" id="status" placeholder="status" >
